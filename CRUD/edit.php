...
<body>
    ...
    <div class="container">
        ...
        <form action="proses.php?aksi=ubah" method="post">
            ...
            <label for="jenis_kelamin">Jeni Kelamin: </label>
            <div class="radio-group">
                <input type="radio" name="jenis_kelamin" value="L" id="lakki" <?php if ($row['jenis_kelamin'] === 'L')
                    echo 'checked'; ?> required><label for="laki">Laki-laki</label>
                <input type="radio" name="jenis_kelamin" value="p" id="perempuan" <?php if (
                    $row['jenis_kelamin'] === 'p'
                )
